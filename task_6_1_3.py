...
# ОС - Windows 8 x64
# Python - 3.7.3 x32
# Было выделено 286 байт памяти
# В алгоритме ушли от использования промежуточных переменных min_value, max_value, что позволило существенно снизить
# объем используемой памяти. По этому показателю данный алгоритм является лучшей из трех реализаций.
